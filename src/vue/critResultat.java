 ...
 *
 * @author 
 * cette classe est une partie integrante de l'interface Vue(package Vue)
 * Elle contien un contructeur qui met un parametre un objet de type Controleur et un objet de type Chercheur
 * 
 */
public class critResultat extends javax.swing.JPanel
{
    ...
    /**
     * le contructeur est utilise quand la 
     * @see  menuProduit est appelle
     * @param controleur utilise pour pointé vers la mehode situé dans controleur 
     * @see Controleur#listeZones() qui va charge un vecteur de type generique 
     * @param parent n'est pas utilisé
     */
    ...
    private void buttonAjoutZoneActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAjoutZoneActionPerformed
     ...
     /**
     * cette mehode est utilisé quand le button Chercher est actioné
     * envoie des événements à cette methode
     * @param evt est un objet de type java.awt.event.ActionEvent
     */
    ...
    /**
     * cette mehode est utilisé quand le button Nouveau est actioné
     * cette methode est utilisé pour crée un object de type: 
     * @see #ProduitForm
     * @param evt est un objet de type java.awt.event.ActionEvent
     */
    ...
    /**
     * 
     * @param f un objet de type Form est utilisé pour manipuler dans ce cas des 
     * methodes comme:
     * @see ProduitForm#getType() qui determine le quel atribut de la liste a éte actioné le Jeu soit la Console
     * @see ProduitForm#getNom() 
     * @see ProduitForm#getEditeur() 
     * etc
     */
    ...
    /**
     * 
     * @return Form est utilisé pour certaines erreurs specifique expres de développeur
     * @throws DonneeInvalideException va retourbe des messages des erreurs
     */
